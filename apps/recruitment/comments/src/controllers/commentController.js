...
import { BaseController } from '@app/shared/controllers/index.js';
import { successResponse } from '@app/shared/utils/index.js';
...
export class CommentController extends BaseController {
  ...
  async likeComment(req, res) {
    try {
      ...
      this.logger.info(API_MESSAGES.SUCCESS.COMMENT_LIKED, {
        commentId: id,
        likes,
        dislikes,
      });
      ...
      return res
        ...
        .json(
          successResponse(
            { id, likes, dislikes },
            API_MESSAGES.SUCCESS.COMMENT_LIKED,
            HTTP_STATUS.OK
          )
        );
    } catch (error) {
  ...
  async dislikeComment(req, res) {
    try {
      ...
      this.logger.info(API_MESSAGES.SUCCESS.COMMENT_DISLIKED, {
        commentId: id,
        likes,
        dislikes,
      });
      ...
      return res
        ...
        .json(
          successResponse(
            { id, likes, dislikes },
            API_MESSAGES.SUCCESS.COMMENT_DISLIKED,
            HTTP_STATUS.OK
          )
        );
    } catch (error) {
